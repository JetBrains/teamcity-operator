...
# jetbrains.com/teamcity-operator-bundle:$VERSION and jetbrains.com/teamcity-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= jetbrains.com/teamcity-operator
...
IMG ?= registry.jetbrains.team/p/tch/tccloud-containers/teamcity-operator:latest
...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) --bin-dir $(LOCALBIN) -p path)" ginkgo --teamcity-report report.out --coverprofile=cover.out -coverpkg=./... -v -r ./... ${TEST_FLAGS}
